...
class PANLayer(nn.Module):
    ...
    def forward(self, x, lateral):
        x = F.interpolate(x, size=lateral.shape[-3:], mode="trilinear", align_corners=False)  
...
class UKAN(nn.Module):
    ...
    def forward(self, x):
        ...
        pan1 = self.pan1(t3, t2)  
        
        pan1 = self.eca1(pan1)
        
        pan2 = self.pan2(pan1, t1)  
...
if __name__ == '__main__':
    ...
    model = UKAN(input_channnel=4,num_classes=4)
