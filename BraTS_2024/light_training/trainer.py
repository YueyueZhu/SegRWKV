...
class Trainer:
    def __init__(self, env_type,
        ...
        self.num_step_per_epoch = 300 // self.num_gpus
        self.val_number = 130 // self.num_gpus
    ...
    def validation_single_gpu_two_metrics(self, val_dataset,):
        ...
        print("Average Dice: ET: {}  NETC: {}  SNFH: {}  RC: {}, TC: {}, WT: {}".format(dice_sum[0], dice_sum[1], dice_sum[2], dice_sum[3], dice_sum[4], dice_sum[5]))
        print("Average HD95: ET: {} , NETC: {}, SNFH: {}  RC: {}, TC: {}, WT: {}".format(hd95_sum[0], hd95_sum[1], hd95_sum[2], hd95_sum[3], hd95_sum[4], hd95_sum[5]))
        print("Average Dice: {}  ".format(((dice_sum[0] + dice_sum[1] + dice_sum[2]+dice_sum[3]+dice_sum[4]+dice_sum[5])/len(dice_sum))))
        print("Average HD95: {}  ".format(((hd95_sum[0] + hd95_sum[1] + hd95_sum[2]+hd95_sum[3]+hd95_sum[4]+hd95_sum[5])/len(hd95_sum))))
